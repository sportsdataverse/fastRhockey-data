...
pacman::p_load_current_gh("sportsdataverse/fastRhockey")
...
suppressPackageStartupMessages(suppressMessages(library(fastRhockey, lib.loc="C:\\Users\\saiem\\AppData\\Local\\R\\win-library\\4.2")))
